...
class DefaultPromptStyle(AbstractPromptStyle):
    ...
    def _messages_to_prompt(self, messages: Sequence[ChatMessage], system_prompt: Optional[str] = None) -> str:
    ...
    def _completion_to_prompt(self, completion: str, system_prompt: Optional[str] = None) -> str:
